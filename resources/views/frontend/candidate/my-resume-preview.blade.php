    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class=" text-lg-end">
                <button onclick="PrintPage()" class="btn btn-primary btn-md mb-4 mb-lg-0">
                    Download</button>
            </div>
            <div class="col-md-9">
                                ...
                                <div class="jobber-user-info">
                                    <div class="profile-avatar ">
                                        <img class="img-fluid" src="{{ asset(Auth::user()?->profile?->profileImage) }}"
                                            id="profile_img" alt="profile_image">
                                    </div>
...
<script>
    // function PrintPage() {
    //     console.log('PrintPage function called');
    //     let printContents = document.getElementById('resume').innerHTML;
    //     let logoSrc = document.querySelector('#profile_img').src;
    //     let logoImg = `<img class="w-10" src="${logoSrc}">`;
    //     printContents = logoSrc + printContents;
    ...
    //     let printContents = document.getElementById('resume').innerHTML;
    //     let logoSrc = document.querySelector('#profile_img').src;
    //     let logoImg = `<img class="w-10" src="${logoSrc}">`; // Wrap logoSrc in an img tag
    //     printContents = logoImg + printContents; // Concatenate logoImg and printContents
